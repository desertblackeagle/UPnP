package rose.traditionalDevice.myDisplay;
...
public class DisplayDevice extends Device implements ActionListener, QueryListener {
	...
	public DisplayDevice() throws InvalidDescriptionException, IOException
	{
		super();
