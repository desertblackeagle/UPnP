...
public class TraditionalGUI extends JFrame {
	private TraditionalControlPoint cp;
	...
	private void init() {
		title = new JLabel("傳統 Control Point");
	...
	private void cpInit() {
		cp = new TraditionalControlPoint(this);
		cp.start();
		cp.searchDevice();
		cp.invokeDevice();
	}
	...
	public static void main(String[] args) {
		...
		TraditionalGUI traditionalGUI = new TraditionalGUI();
	}
