...
public class SemantciDeviceTest extends SemanticDevice implements ActionListener, QueryListener{
	...
	private final static String DEVICE_DESCRIPTION = 
		...
		" 	</specVersion> \n" +
		" 	<device> \n" +
		" 		<deviceType>urn:schemas-upnp-org:device:display:1</deviceType>  \n" +
		" 		<friendlyName>CyberGarage Display Device</friendlyName>  \n" +
		" 		<manufacturer>CyberGarage</manufacturer>  \n" +
		" 		<manufacturerURL>http://www.cybergarage.org</manufacturerURL>  \n" +
		" 		<modelDescription>CyberUPnP Display Device</modelDescription>  \n" +
		" 		<modelName>Display</modelName>  \n" +
		" 		<modelNumber>1.0</modelNumber>  \n" +
		" 		<modelURL>http://www.cybergarage.org</modelURL>  \n" +
		" 		<serialNumber>1234567821</serialNumber>  \n" +
		" 		<UDN>uuid:cybergarageDisplayDevice</UDN>  \n" +
	...
	public SemantciDeviceTest() throws InvalidDescriptionException, IOException
	{
		super();
	...
	public static void main(String[] args) {
		...
		try {
			SemantciDeviceTest d = new SemantciDeviceTest();
			d.start();
