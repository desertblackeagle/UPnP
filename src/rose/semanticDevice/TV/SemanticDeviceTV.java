package rose.semanticDevice.TV;
...
public class SemanticDeviceTV extends SemanticDevice implements ActionListener, QueryListener{
	...
	private final static String DEVICE_DESCRIPTION = 
		...
		" 		<friendlyName>CyberGarage TV Device</friendlyName>  \n" +
		...
		" 		<serialNumber>1234567829</serialNumber>  \n" +
		" 		<UDN>uuid:cybergarageTVDevice</UDN>  \n" +
		" 		<UPC>123456789015</UPC>  \n" +
		" 		<iconList> \n" +
		" 			<icon> \n" +
	...
	public SemanticDeviceTV() throws InvalidDescriptionException, IOException
	{
		super();
...
//		semanticDeviceStart();
	...
	public static void main(String[] args) {
		...
		try {
			SemanticDeviceTV d = new SemanticDeviceTV();
			d.start();
