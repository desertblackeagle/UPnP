...
public class SemanticDeviceLight extends SemanticDevice implements ActionListener, QueryListener{
	...
	public SemanticDeviceLight() throws InvalidDescriptionException, IOException
	{
		super();
	...
	public void announce(String bindAddr) {
		...
		for (int i = 1; i <= 100; i++) {
			...
			test(bindAddr, "http://192.168.1.239/upnp/lcd/description" + i + ".xml");
		}
	}

	public void test(String bindAddr, String a) {
		...
		ssdpReq.setLocation(a);
		ssdpReq.setNTS(NTS.ALIVE);

		// uuid:device-UUID(::upnp:rootdevice)*
		if (isRootDevice() == true) {
			String devNT = "upnp:rootdevice";
			String devUSN = "uuid:cybergarageTVDevice::upnp:rootdevice";
			ssdpReq.setNT(devNT);
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		try {
			SemanticDeviceLight d = new SemanticDeviceLight();
			d.start();
