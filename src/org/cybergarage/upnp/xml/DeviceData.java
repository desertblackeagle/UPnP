...
public class DeviceData extends NodeData
{
    ...
    /*
     * public void setControlActionListenerList(ListenerList controlActionListenerList) { this.controlActionListenerList
     * = controlActionListenerList; }
     */
     ...
     * 
     * @param port
     *            The port to use for binding the SSDP service. The port will be
     *            used as source port for all SSDP messages
     * @since 1.8
     */
     ...
     * 
     * @param inets
     *            The <tt>InetAddress</tt> that will be binded for listing this
     *            service. Use <code>null</code> for the default behaviur.
     * @see {@link UPnP}
     * @see {@link USSDP}
     ...
     * 
     * @param ip
     *            The IPv4 address used as destination address for Multicast
     *            comunication
     * @since 1.8
     */
     ...
     * 
     * @param ip
     *            The IPv6 address used as destination address for Multicast
     *            comunication
     * @since 1.8
     */
